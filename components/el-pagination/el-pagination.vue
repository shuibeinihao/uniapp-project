<template>
	<view class="uni-pagination">
		<!-- #ifndef MP -->
		<picker class="select-picker" mode="selector"
    ...
    <view class="uni-pagination__btn"
      ...
      style="margin-right: 10rpx;"
			:hover-stay-time="70" @click="clickFirst">
			<template>
				<text class="uni-pagination__child-btn">首页</text>
			</template>
		</view>
		<view class="uni-pagination__btn"
			:class="currentIndex === 1 ? 'uni-pagination--disabled' : 'uni-pagination--enabled'"
    ...
    <view class="uni-pagination__num uni-pagination__num-flex-none">
      <picker class="uni-pagination__num-picker" mode="selector"
        :value="current - 1" :range="paperData" @change="paperChange">
    ...
    <view class="uni-pagination__btn"
      ...
      style="margin-left: 10rpx;"
			:hover-stay-time="70" @click="clickLast">
			<template>
				<text class="uni-pagination__child-btn">末页</text>
			</template>
		</view>
	</view>
</template>
...
<script>
	...
	export default {
      ...
      paperChange(e) {
        this.currentIndex = Number(e.detail.value) + 1
        this.change('current')
      },
			// 选择标签
			selectPage(e, index) {
